...
export class OrderBookApi {
  ...
  async getOrders(
    ...
    const orders = await this.fetch<Array<EnrichedOrder>>(
   ...
   * @see {@link EnrichedOrder}
   */
  async getTxOrders(txHash: TransactionHash, contextOverride: PartialApiContext = {}): Promise<Array<EnrichedOrder>> {
   ...
   */
  async getOrder(orderUid: UID, contextOverride: PartialApiContext = {}): Promise<EnrichedOrder> {
   ...
   */
  async getOrderMultiEnv(orderUid: UID, contextOverride: PartialApiContext = {}): Promise<EnrichedOrder> {
