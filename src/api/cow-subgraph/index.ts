...
export function getSubgraphUrls(): Record<ChainId, string> {
  return {
    [ChainId.MAINNET]: 'https://api.thegraph.com/subgraphs/name/gnosis/cow',
    [ChainId.RINKEBY]: 'https://api.thegraph.com/subgraphs/name/gnosis/cow-rinkeby',
    [ChainId.GNOSIS_CHAIN]: 'https://api.thegraph.com/subgraphs/name/gnosis/cow-gc',
  }
}
