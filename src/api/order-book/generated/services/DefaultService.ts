...
export class DefaultService {
   ...
   * @throws ApiError
   */
  public postApiV1Orders(requestBody: OrderCreation): CancelablePromise<UID> {
   ...
   * @throws ApiError
   */
  public deleteApiV1Orders(requestBody: OrderCancellations): CancelablePromise<any> {
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/api/v1/orders',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public getApiV1Orders(uid: UID): CancelablePromise<Order> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public deleteApiV1Orders1(uid: UID, requestBody: OrderCancellation): CancelablePromise<any> {
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/api/v1/orders/{UID}',
      path: {
   ...
   * @throws ApiError
   */
  public patchApiV1Orders(uid: UID, requestBody: OrderCreation): CancelablePromise<UID> {
    return this.httpRequest.request({
      method: 'PATCH',
      url: '/api/v1/orders/{UID}',
      path: {
   ...
   * @throws ApiError
   */
  public getApiV1TransactionsOrders(txHash: TransactionHash): CancelablePromise<Array<Order>> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public getApiV1Trades(owner?: Address, orderUid?: UID): CancelablePromise<Array<Trade>> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/api/v1/trades',
      query: {
   ...
   * @throws ApiError
   */
  public getApiV1AccountOrders(owner: Address, offset?: number, limit?: number): CancelablePromise<Array<Order>> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public getApiV1TokenNativePrice(token: Address): CancelablePromise<NativePriceResponse> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public postApiV1Quote(requestBody: OrderQuoteRequest): CancelablePromise<OrderQuoteResponse> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/api/v1/quote',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public getApiV1SolverCompetition(auctionId: number): CancelablePromise<SolverCompetitionResponse> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public getApiV1SolverCompetitionByTxHash(txHash: TransactionHash): CancelablePromise<SolverCompetitionResponse> {
    return this.httpRequest.request({
      method: 'GET',
