...
import { PriceQuoteLegacyParams, WithDecimals, WithChainId, PriceInformation, FeeInformation } from '../../types'

export interface GetBestPriceOptions {
  aggrOverride?: 'max' | 'min'
}
export type CompatibleQuoteParams = PriceQuoteLegacyParams & WithDecimals & WithChainId
