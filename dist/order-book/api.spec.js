...
const cowSdk = {
    cowApi: new api_1.OrderBookApi(chainId),
};
...
const ORDER_CANCELLATION = {
    chainId,
    cancellation: Object.assign({ orderUid: '0x59920c85de0162e9e55df8d396e75f3b6b7c2dfdb535f03e5c807731c31585eaff714b8b0e2700303ec912bd40496c3997ceea2b616d6710' }, SIGNED_ORDER_RESPONSE),
...
describe('Cow Api', () => {
    ...
    test('Valid: Get orders link', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const orderLink = yield cowSdk.cowApi.getOrderLink(ORDER_RESPONSE.uid);
    ...
    test('Valid: Get an order', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        // when
        const order = yield cowSdk.cowApi.getOrder(ORDER_RESPONSE.uid);
        // then
    ...
    test('Invalid: Get an order', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        // when
        const promise = cowSdk.cowApi.getOrder('notValidOrderId');
        // then
    ...
    test('Valid: Get last 5 orders for a given trader ', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const orders = yield cowSdk.cowApi.getOrders({
    ...
    test('Valid: Get tx orders from a given txHash', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        jest_fetch_mock_1.default.mockResponse(JSON.stringify(ORDERS_RESPONSE), { status: HTTP_STATUS_OK, headers: HEADERS });
        const txOrders = yield cowSdk.cowApi.getTxOrders(txHash);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
    ...
    test('Valid: Get last 5 trades for a given trader ', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const trades = yield cowSdk.cowApi.getTrades({
    ...
    test('Invalid: Get trades passing both the owner and orderId', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        expect(cowSdk.cowApi.getTrades({
    ...
    test('Valid: Send sign order cancellation', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        yield cowSdk.cowApi.sendSignedOrderCancellation(ORDER_CANCELLATION.cancellation.orderUid, SIGNED_ORDER_RESPONSE);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledWith(`https://api.cow.fi/xdai/api/v1/orders/${ORDER_CANCELLATION.cancellation.orderUid}`, expect.objectContaining(Object.assign(Object.assign({}, RAW_FETCH_RESPONSE_PARAMETERS), { body: JSON.stringify(SIGNED_ORDER_RESPONSE), method: 'DELETE' })));
    }));
    test('Invalid: Send sign not found order cancellation', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        // when
        const promise = cowSdk.cowApi.sendSignedOrderCancellation('unexistingOrder', SIGNED_ORDER_RESPONSE);
        // then
        yield expect(promise).rejects.toThrow('Order was not found');
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
    ...
    test('Valid: Send an order ', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const orderId = yield cowSdk.cowApi.sendOrder(Object.assign(Object.assign(Object.assign({}, ORDER_RESPONSE), SIGNED_ORDER_RESPONSE), { signingScheme: generated_1.SigningScheme.EIP712, from: '0x1811be0994930fe9480eaede25165608b093ad7a' }));
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
    ...
    test('Invalid: Send an duplicate order ', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        // when
        const promise = cowSdk.cowApi.sendOrder(Object.assign(Object.assign(Object.assign({}, ORDER_RESPONSE), SIGNED_ORDER_RESPONSE), { signingScheme: generated_1.SigningScheme.EIP712, from: '0x1811be0994930fe9480eaede25165608b093ad7a' }));
        // then
    ...
    describe('Transform EthFlow orders', () => {
        test('getOrder', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            ...
            // when
            const order = yield cowSdk.cowApi.getOrder(ETH_FLOW_ORDER_RESPONSE.uid);
            // then
