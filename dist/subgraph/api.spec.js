...
const chainId = chains_1.SupportedChainId.MAINNET;
const cowSubgraphApi = new api_1.SubgraphApi();
const prodUrls = configs_1.PROD_CONFIG;
const headers = {
    'Content-Type': 'application/json',
};
const getFetchParameters = (query, operationName, variables) => {
    const body = {
        query,
        variables,
        operationName,
...
describe('Cow subgraph URL', () => {
    ...
    test('Valid: Get Totals', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        jest_fetch_mock_1.default.mockResponseOnce(JSON.stringify(TOTALS_RESPONSE), {
            status: 200,
            headers,
        });
        const totals = yield cowSubgraphApi.getTotals(chainId);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledWith(prodUrls[chains_1.SupportedChainId.MAINNET].subgraphUrl, getFetchParameters(queries_1.TOTALS_QUERY, 'Totals'));
        expect(totals).toEqual(TOTALS_RESPONSE.data.totals[0]);
    }));
    test('Valid: Get Last 7 days volume', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        jest_fetch_mock_1.default.mockResponseOnce(JSON.stringify(LAST_7_DAYS_VOLUME_RESPONSE), {
            status: 200,
            headers,
        });
        const response = yield cowSubgraphApi.getLastDaysVolume(chainId, 7);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledWith(prodUrls[chains_1.SupportedChainId.MAINNET].subgraphUrl, getFetchParameters(queries_1.LAST_DAYS_VOLUME_QUERY, 'LastDaysVolume', { days: 7 }));
        expect(response).toEqual(LAST_7_DAYS_VOLUME_RESPONSE.data);
    }));
    test('Valid: Get Last 24 hours volume', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        jest_fetch_mock_1.default.mockResponseOnce(JSON.stringify(LAST_24_HOURS_VOLUME_RESPONSE), {
            status: 200,
            headers,
        });
        const response = yield cowSubgraphApi.getLastHoursVolume(chainId, 24);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledWith(prodUrls[chains_1.SupportedChainId.MAINNET].subgraphUrl, getFetchParameters(queries_1.LAST_HOURS_VOLUME_QUERY, 'LastHoursVolume', { hours: 24 }));
        expect(response).toEqual(LAST_24_HOURS_VOLUME_RESPONSE.data);
    }));
    test('Valid: Run custom query', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        jest_fetch_mock_1.default.mockResponseOnce(JSON.stringify(TOKENS_BY_VOLUME_RESPONSE), {
            status: 200,
            headers,
        });
        const response = yield cowSubgraphApi.runQuery(chainId, query);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledWith(prodUrls[chains_1.SupportedChainId.MAINNET].subgraphUrl, getFetchParameters(query, 'TokensByVolume'));
        expect(response).toEqual(TOKENS_BY_VOLUME_RESPONSE.data);
    }));
    test('Invalid: non-existent query', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const query = (0, graphql_request_1.gql) `
      query InvalidQuery {
        invalidQuery {
          field1
    ...
    `;
        jest_fetch_mock_1.default.mockResponseOnce(JSON.stringify(INVALID_QUERY_RESPONSE), {
            status: 200,
            headers,
        });
        yield expect(cowSubgraphApi.runQuery(chainId, query)).rejects.toThrowError(cow_error_1.CowError);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledWith(prodUrls[chains_1.SupportedChainId.MAINNET].subgraphUrl, getFetchParameters(query, 'InvalidQuery'));
    }));
});
