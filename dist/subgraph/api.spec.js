...
const cowSubgraphApi = new api_1.SubgraphApi(chains_1.SupportedChainId.MAINNET);
...
describe('Cow subgraph URL', () => {
    ...
    test('Valid: Get Totals', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const totals = yield cowSubgraphApi.getTotals();
    ...
    test('Valid: Get Last 7 days volume', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const response = yield cowSubgraphApi.getLastDaysVolume(7);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
    ...
    test('Valid: Get Last 24 hours volume', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const response = yield cowSubgraphApi.getLastHoursVolume(24);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
    ...
    `;
        ...
        const response = yield cowSubgraphApi.runQuery(query);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
    ...
    `;
        ...
        yield expect(cowSubgraphApi.runQuery(query)).rejects.toThrowError(cow_error_1.CowError);
        expect(jest_fetch_mock_1.default).toHaveBeenCalledTimes(1);
