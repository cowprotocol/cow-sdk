...
class MetadataApi {
    ...
    generateAppDataDoc(params) {
        ...
        return {
            appCode: (appDataParams === null || appDataParams === void 0 ? void 0 : appDataParams.appCode) || DEFAULT_APP_CODE,
            environment: appDataParams === null || appDataParams === void 0 ? void 0 : appDataParams.environment,
            metadata: Object.assign(Object.assign(Object.assign({}, (referrerParams ? { referrer: Object.assign(Object.assign({}, referrerParams), { version: REFERRER_VERSION }) } : null)), (quoteParams ? { quote: Object.assign(Object.assign({}, quoteParams), { version: QUOTE_VERSION }) } : null)), (orderClassParams ? { orderClass: Object.assign(Object.assign({}, orderClassParams), { version: ORDER_CLASS_VERSION }) } : null)),
