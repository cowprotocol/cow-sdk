...
export const WRAPPED_NATIVE_CURRENCIES: Record<SupportedEvmChainId, TokenInfo> = {
  [SupportedEvmChainId.MAINNET]: getWrappedTokenForChain(
    SupportedEvmChainId.MAINNET,
    '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2',
    wrappedNativeCurrencyEth,
  ),
  [SupportedEvmChainId.GNOSIS_CHAIN]: getWrappedTokenForChain(
  ...
  [SupportedEvmChainId.ARBITRUM_ONE]: getWrappedTokenForChain(
    SupportedEvmChainId.ARBITRUM_ONE,
    '0x82aF49447D8a07e3bd95BD0d56f35241523fBab1',
    wrappedNativeCurrencyEth,
  ),
  [SupportedEvmChainId.BASE]: getWrappedTokenForChain(
    SupportedEvmChainId.BASE,
    '0x4200000000000000000000000000000000000006',
    wrappedNativeCurrencyEth,
  ),
  [SupportedEvmChainId.SEPOLIA]: getWrappedTokenForChain(
    SupportedEvmChainId.SEPOLIA,
    '0xfFf9976782d46CC05630D1f6eBAb18b2324d6B14',
    wrappedNativeCurrencyEth,
  ),
  [SupportedEvmChainId.POLYGON]: getWrappedTokenForChain(
  ...
  [SupportedEvmChainId.AVALANCHE]: getWrappedTokenForChain(
  ...
  [SupportedEvmChainId.LENS]: getWrappedTokenForChain(
  ...
  [SupportedEvmChainId.BNB]: getWrappedTokenForChain(SupportedEvmChainId.BNB, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', {
    decimals: 18,
    name: 'Wrapped BNB',
    symbol: 'WBNB',
  }),
  [SupportedEvmChainId.PLASMA]: getWrappedTokenForChain(
  ...
  [SupportedEvmChainId.LINEA]: getWrappedTokenForChain(
    SupportedEvmChainId.LINEA,
    '0xe5d7c2a44ffddf6b295a15c148167daaaf5cf34f',
    wrappedNativeCurrencyEth,
  ),
  [SupportedEvmChainId.INK]: getWrappedTokenForChain(
