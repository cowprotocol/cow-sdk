 ...
 */
export const EVM_NATIVE_CURRENCY_ADDRESS = '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE'
 ...
 */
export const BTC_CURRENCY_ADDRESS = '1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa'
