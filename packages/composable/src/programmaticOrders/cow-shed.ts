...
import { ADDRESS_SCHEMA, BYTES_32_SCHEMA, SAFE_INTEGER_SCHEMA, UINT256_SCHEMA } from './schemas'

export const GET_DEPLOYED_COW_SHEDS_PARAMS_SCHEMA = v.object({ owner: ADDRESS_SCHEMA })
...
export const COW_SHEDS_QUERY = `
  query DeployedCowSheds($owner: String!, $offset: Int! = 0, $limit: Int! = 100, $direction: String! = "desc") {
    ownerMappings(
      where: { owner: $owner, addressType: cowshed_proxy }
      offset: $offset
      limit: $limit
      orderBy: "address"
