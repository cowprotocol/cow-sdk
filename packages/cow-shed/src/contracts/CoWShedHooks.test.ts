...
import { COW_SHED_2_1_0_VERSION, COW_SHED_FACTORY, COW_SHED_IMPLEMENTATION, COW_SHED_PROXY_INIT_CODE } from '../const'
  ...
  describe('constructor', () => {
    ...
    it('should create a new instance of CowShedHooks with default values', () => {
      ...
      adapterNames.forEach((adapterName) => {
        ...
        expect(defaultCowShed.version).toBe(COW_SHED_2_1_0_VERSION)
        expect(COW_SHED_FACTORY[COW_SHED_2_1_0_VERSION]).toBe('0xC94F7D71d022e773B0B516841ff867C06f39726B')
        expect(COW_SHED_IMPLEMENTATION[COW_SHED_2_1_0_VERSION]).toBe('0xF0D586aB0017fDfE2ACf4AB008B3Ddb2CF50bB09')
        expect(defaultCowShed.getFactoryAddress()).toBe(COW_SHED_FACTORY[COW_SHED_2_1_0_VERSION])
        expect(defaultCowShed.getImplementationAddress()).toBe(COW_SHED_IMPLEMENTATION[COW_SHED_2_1_0_VERSION])
        expect(defaultCowShed.proxyCreationCode()).toBe(COW_SHED_PROXY_INIT_CODE[COW_SHED_2_1_0_VERSION])
  ...
  describe('computeProxyAddress', () => {
    ...
    it('should use the right parameters on the proxy address for default values', () => {
      ...
      adapterNames.forEach((adapterName) => {
        ...
        expect(calculatedProxy).toBe('0x21e06C9C8f7C99F04e613c49F956BA23a3477CcC')
      })
    })
  })
