...
import { COW_SHED_FACTORY, COW_SHED_IMPLEMENTATION, COW_SHED_PROXY_INIT_CODE } from '../const'
  ...
  describe('constructor', () => {
    ...
    it('should create a new instance of CowShedHooks with default values', () => {
      ...
      adapterNames.forEach((adapterName) => {
        ...
        expect(defaultCowShed.proxyCreationCode()).toBe(COW_SHED_PROXY_INIT_CODE[defaultCowShed.version])
      })
    })
  })
  ...
  describe('computeProxyAddress', () => {
    ...
    it('should use the right parameters on the proxy address for default values', () => {
      ...
      adapterNames.forEach((adapterName) => {
        ...
        expect(calculatedProxy).toBe('0x129b0a18C3De94D0982856e96585c33ce2CEabdD')
      })
    })
  })
