...
import type { AddressKey, AbstractSigner, Provider, SignerLike } from '@cowprotocol/sdk-common'
...
export type QuoterParameters = Omit<TraderParameters, 'signer'> & { account: AddressKey }
