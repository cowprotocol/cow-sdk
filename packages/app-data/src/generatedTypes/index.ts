...
import * as v1_11_0 from './v1.11.0'
import * as v1_12_0 from './v1.12.0'
import * as v1_13_0 from './v1.13.0'
import * as v1_14_0 from './v1.14.0'
import * as v1_15_0 from './v1.15.0'
import * as v1_16_0 from './v1.16.0'
...
export const LATEST_APP_DATA_VERSION = '1.16.0'
export const LATEST_QUOTE_METADATA_VERSION = '1.1.0'
export const LATEST_REFERRER_METADATA_VERSION = '1.0.0'
...
export const LATEST_PARTNER_FEE_METADATA_VERSION = '1.1.0'
...
export type LatestAppDataDocVersion = v1_16_0.AppDataRootSchema
export type AnyAppDataDocVersion = 
  | v1_16_0.AppDataRootSchema
  | v1_15_0.AppDataRootSchema
  | v1_14_0.AppDataRootSchema
  | v1_13_0.AppDataRootSchema
  | v1_12_0.AppDataRootSchema
